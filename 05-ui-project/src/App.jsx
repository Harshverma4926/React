...
const App = () => {
  const users=[
    ...
    {
      img:'https://plus.unsplash.com/premium_photo-1683141474032-ed925681010a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDY0fHx8ZW58MHx8fHx8',
      intro:'',
      tag:'Underworked'
    }
  ]
